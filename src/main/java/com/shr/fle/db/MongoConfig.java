...
import com.shr.fle.converters.BinaryToBsonBinaryConverter;
import com.shr.fle.converters.BinaryToBsonStringConverter;
import com.shr.fle.converters.BsonBinaryToBinaryConverter;
 ...
 */
@Configuration
@EnableMongoRepositories(basePackages = "com.shr.users.repositories")
	...
	public CustomConversions customConversions() {
		CustomConversions customConversions = new MongoCustomConversions(
				Arrays.asList(new BinaryToBsonBinaryConverter(),
						...
						new BinaryToBsonStringConverter()));
